...
const buttonVariants = cva(
  "bg-transparent border-none px-4 py-2 rounded-lg text-white transition-all duration-200 inline-flex items-center gap-1 justify-center disabled:bg-gray-400 disabled:shadow-neutral-700/50 disabled:dark:bg-neutral-700",
  {
    variants: {
      variant: {
        primary:
